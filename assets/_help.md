...
+ PARA-PLOT - parallel coordinates plot that allows to visualize many parameters and selected fields at once.  
+ TOTAL SCORE - to design rules to aggregate multiple features into **total score** and rank the best candidates in the histogram below.
